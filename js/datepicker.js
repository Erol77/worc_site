...
(function () {
	...
	window.xCal = function (ob, delim, order) { // xCal(this,'-',1) // xCal() == close
		...
		xCal.f = function (a) {
			...
			// console.log(Dlast, '   ', '   ', DNlast, '  ' + DNfirst)
			...
			document.querySelector("#" + a.id + " thead td.cal-lY").onclick = function () {
				xCal.mmmY(a)
			}
			document.querySelector("#" + a.id + " thead td.cal-rY").onclick = function () {
				xCal.mppY(a)
			}
			...
			var rY = document.querySelector("#" + a.id + " tbody td.cal-lY");
			if (r != null) {
				r.onclick = function () {
					xCal.mmm(a)
				}
			...
			rY = document.querySelector("#" + a.id + " tbody td.cal-rY");
			if (rY != null) {
				rY.onclick = function () {
					xCal.mppY(a)
				}
